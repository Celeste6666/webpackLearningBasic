...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _css_main_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../css/main.css */ \"./src/css/main.css\");\n\n\nconsole.log('index文件初始化')\n// 懶加載\n// 在有需要時才加載，例如按下按鈕後才去加載某資源並執行\ndocument.querySelector('button')\n  .addEventListener('click', async (e) => {\n  const {plus,multiple} = await __webpack_require__.e(/*! import() | calculate */ \"calculate\").then(__webpack_require__.bind(__webpack_require__, /*! ./calculate */ \"./src/js/calculate.js\"));\n  console.log('calculate 模塊是等按下按鈕才加載');\n  plus(2,4)\n  multiple(2,4)\n})\n\n//# sourceURL=webpack:///./src/js/index.js?");
